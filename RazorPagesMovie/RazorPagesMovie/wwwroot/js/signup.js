window.onload = function () {
    ...
    form.addEventListener('submit', (e) => {
        ...
        if (!check) {
            ...
            jAlert('Заполните все поля!', 'Ошибка ввода');
            return;
        }
        if (!loginIsCorrect) {
            //alert ('Логин должен сожержать минимум 3 символа и состоять только из букв!');
            jAlert('Логин должен сожержать минимум 3 символа и состоять только из букв!', 'Неподходящий логин');
            return;
        }
        if (!parolIsCorrect) {
            ...
            jAlert('Пароль слишком пройстой!\nОн должен состоять минимум из 6 символов\nи содержать минимум одну цифру, одну заглавную и одну строчную буквы.', 'Неподходящий пароль');
            return;
        }
        if (!parolsAreEqual) {
            //alert ('Пароли не совпадают!');
            jAlert('Пароли не совпадают!', 'Ошибка ввода');
            return;
        }
